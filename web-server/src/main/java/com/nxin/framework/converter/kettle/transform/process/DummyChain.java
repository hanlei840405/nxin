...
@Slf4j
public class DummyChain extends TransformConvertChain {

    @Override
    public ResponseMeta parse(mxCell cell, TransMeta transMeta) throws JsonProcessingException {
        if (cell.isVertex() && "DummyTransMeta".equalsIgnoreCase(cell.getStyle())) {
            ...
            StepMeta stepMeta = new StepMeta(stepName, dummyTransMeta);
