    ...
    public ResponseMeta parse(mxCell cell, TransMeta transMeta) throws JsonProcessingException {
        if (cell.isVertex() && "JmsConsumerMeta".equalsIgnoreCase(cell.getStyle())) {
            ...
            if (transformShell.getExecutable()) {
                jmsConsumerMeta.setTransformationPath(transformShell.getProjectId() + File.separator + transformShell.getParentId() + File.separator + transformShell.getId() + Constant.DOT + Constant.TRANS_SUFFIX);
            }
