...
import com.nxin.framework.jwt.JwtTokenUtil;
import com.nxin.framework.jwt.JwtUserDetailsService;
import com.nxin.framework.jwt.JwtUtil;
import com.nxin.framework.service.auth.UserService;
import com.nxin.framework.vo.auth.AuthVo;
...
public class JwtAuthenticationController {
    ...
    public ResponseEntity changePwd(@RequestBody AuthDto authDto, Principal principal) {
    ...
    public ResponseEntity<AuthVo> me(Principal principal) {
        User user = userService.one(principal.getName());
        return ResponseEntity.ok(AuthVo.builder().username(user.getEmail()).name(user.getName()).build());
    }
